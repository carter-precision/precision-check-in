...
| --: | ---------------------------------------------------- | ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   1 | Manual 2017 Ford Fusion, final `vehicle_id=66687`    | Offline pass; live lookup unavailable | The automated contract suite verifies Year `2017` → Ford `13` → Fusion `4543` → `4 Door Sedan` / vehicle `66687`, including modifier preservation. The kiosk displayed its lookup-outage retry state when the live Year request failed.                  |
